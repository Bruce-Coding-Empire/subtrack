...
export class InitSchema1784639292193 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "notification_preferences" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid NOT NULL, "renewal_reminders_enabled" boolean NOT NULL DEFAULT false, "spend_limit_alerts_enabled" boolean NOT NULL DEFAULT false, "push_token" text, CONSTRAINT "PK_e94e2b543f2f218ee68e4f4fad2" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."subscriptions_billing_cycle_enum" AS ENUM('weekly', 'monthly', 'yearly', 'custom')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."subscriptions_category_enum" AS ENUM('entertainment', 'software', 'fitness', 'utilities', 'other')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."subscriptions_status_enum" AS ENUM('active', 'cancelled')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_49c67bacd5be8771fdd48781b5" ON "payment_history"  ("subscription_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_87a6f5afc86958a2206e337065" ON "payment_history"  ("user_id") `,
    );
    await queryRunner.query(
      `CREATE TABLE "exchange_rates" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "base_currency" character varying NOT NULL, "target_currency" character varying NOT NULL, "rate" numeric NOT NULL, "fetched_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_33a614bad9e61956079d817ebe2" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "UQ_exchange_rates_pair_date" ON "exchange_rates" ("base_currency", "target_currency", (("fetched_at")::date))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "payment_history" ADD CONSTRAINT "FK_49c67bacd5be8771fdd48781b55" FOREIGN KEY ("subscription_id") REFERENCES "subscriptions"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "payment_history" DROP CONSTRAINT "FK_49c67bacd5be8771fdd48781b55"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."UQ_exchange_rates_pair_date"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_49c67bacd5be8771fdd48781b5"`,
    );
